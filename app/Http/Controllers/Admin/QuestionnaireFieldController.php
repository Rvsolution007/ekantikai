...
class QuestionnaireFieldController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        QuestionnaireField::create([
            ...
            'is_unique_key' => $validated['is_unique_key'] ?? false,
            'unique_key_order' => $validated['unique_key_order'],
            'options_source' => $validated['options_source'],
            'options_manual' => $validated['options_manual'],
            'catalogue_field' => $validated['catalogue_field'],
