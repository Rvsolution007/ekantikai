...
class ProjectStructureController extends Controller
{
    ...
    public function showLeads()
    {
        ...
        // Dummy Product Quotation Data - ProductQuestion fields se kaise save hota hai
        $dummyProductQuotation = [
            [
                'id' => 1,
                'lead_id' => 101,
                ...
                'finish' => 'Matt Black',
                'qty' => 50,
                'unique_key' => '9007|4 inch|Matt Black',
                'source' => 'bot',
            ],
            [
                'id' => 2,
                ...
                'finish' => 'Rose Gold',
                'qty' => 30,
                'unique_key' => '9008|6 inch|Rose Gold',
                'source' => 'bot',
            ],
            [
                'id' => 3,
                'lead_id' => 101,
                'category' => 'Knob Handle',
                'model' => '7001',
                'size' => '25mm',
                'finish' => 'Chrome',
                'qty' => 100,
                'unique_key' => '7001|25mm|Chrome',
                'source' => 'bot',
            ],
            [
                'id' => 4,
                ...
                'qty' => 25,
                'unique_key' => '5055|8 inch|Antique Brass',
                'source' => 'manual',
            ],
            [
                'id' => 5,
            ...
            [
                ...
                'finish' => 'Matt Black',
                'qty' => 10,
                'unique_key' => '3022|18 inch|Matt Black',
                'source' => 'bot',
            ],
            [
                'id' => 7,
                ...
                'finish' => 'Rose Gold',
                'qty' => 200,
                'unique_key' => '7005|32mm|Rose Gold',
                'source' => 'bot',
            ],
            [
                'id' => 8,
            ...
            [
                ...
                'finish' => 'Matt Black',
                'qty' => 20,
                'unique_key' => '5060|10 inch|Matt Black',
                'source' => 'bot',
            ],
            [
                'id' => 10,
                ...
                'finish' => 'Antique Brass',
                'qty' => 60,
                'unique_key' => '9020|6 inch|Antique Brass',
                'source' => 'bot',
            ],
            [
                'id' => 11,
            ...
            [
                ...
                'finish' => 'Matt Black',
                'qty' => 150,
                'unique_key' => '7010|40mm|Matt Black',
                'source' => 'bot',
            ],
        ];

        // Field mapping - ProductQuestion se LeadProduct column mapping
        $fieldMapping = [
            [
                'product_question_field' => 'category',
                'display_name' => 'Category',
                'lead_product_column' => 'category',
                'storage_type' => 'Direct Column',
                'connection' => '✅ Auto Sync',
            ],
            [
                'product_question_field' => 'model',
                'display_name' => 'Model Number',
                'lead_product_column' => 'model',
                'storage_type' => 'Direct Column',
                'connection' => '✅ Auto Sync',
            ],
            [
                'product_question_field' => 'size',
                'display_name' => 'Size',
                'lead_product_column' => 'size',
                'storage_type' => 'Direct Column',
                'connection' => '✅ Auto Sync',
            ],
            [
                'product_question_field' => 'finish',
                'display_name' => 'Finish/Color',
                'lead_product_column' => 'finish',
                'storage_type' => 'Direct Column',
                'connection' => '✅ Auto Sync',
            ],
            [
                'product_question_field' => 'qty',
                'display_name' => 'Quantity',
                'lead_product_column' => 'qty',
                'storage_type' => 'Direct Column',
                'connection' => '✅ Auto Sync',
            ],
            [
                'product_question_field' => 'custom_field_*',
                'display_name' => 'Any Custom Field',
                'lead_product_column' => 'data (JSON)',
                'storage_type' => 'JSON Storage',
                'connection' => '✅ Dynamic Storage',
            ],
        ];
        ...
        return view('superadmin.project-structure.leads', [
            ...
            'errorScenarios' => $errorScenarios,
            'dummyProductQuotation' => $dummyProductQuotation,
