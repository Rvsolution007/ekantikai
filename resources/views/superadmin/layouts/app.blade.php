    ...
    <div x-data="{ sidebarOpen: true, mobileMenuOpen: false }" class="flex h-screen overflow-hidden">
        ...
        <aside :class="sidebarOpen ? 'w-64' : 'w-20'"
            ...
            <nav class="flex-1 overflow-y-auto py-4 px-3 space-y-1">
                ...
                <a href="{{ route('superadmin.connections.index') }}"
                    class="sidebar-link flex items-center space-x-3 px-3 py-2.5 rounded-xl text-gray-300 hover:text-white {{ request()->routeIs('superadmin.connections.*') ? 'active' : '' }}">
                    <svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                <a href="{{ route('superadmin.debug.index') }}"
                    class="sidebar-link flex items-center space-x-3 px-3 py-2.5 rounded-xl text-gray-300 hover:text-white {{ request()->routeIs('superadmin.debug.*') ? 'active' : '' }}">
                    <svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-6 9l2 2 4-4" />
                    </svg>
                    <span x-show="sidebarOpen">Debug</span>
                </a>

                <a href="{{ route('superadmin.project-structure.index') }}"
                    class="sidebar-link flex items-center space-x-3 px-3 py-2.5 rounded-xl text-gray-300 hover:text-white {{ request()->routeIs('superadmin.project-structure.*') ? 'active' : '' }}">
                    <svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            d="M9 17V7m0 10a2 2 0 01-2 2H5a2 2 0 01-2-2V7a2 2 0 012-2h2a2 2 0 012 2m0 10a2 2 0 002 2h2a2 2 0 002-2M9 7a2 2 0 012-2h2a2 2 0 012 2m0 10V7m0 10a2 2 0 002 2h2a2 2 0 002-2V7a2 2 0 00-2-2h-2a2 2 0 00-2 2" />
                    </svg>
                    <span x-show="sidebarOpen">Project Structure</span>
                </a>
            </nav>
