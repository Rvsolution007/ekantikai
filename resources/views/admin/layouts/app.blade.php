        ...
        <aside :class="sidebarOpen ? 'w-64' : 'w-20'"
            ...
            <nav class="flex-1 overflow-y-auto py-4 px-3 space-y-1">
                ...
                <a href="{{ route('admin.leads.index') }}"
                    class="sidebar-link flex items-center space-x-3 px-3 py-2.5 rounded-xl text-gray-300 hover:text-white {{ request()->routeIs('admin.leads.*') ? 'active' : '' }}">
                    <svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                <a href="{{ route('admin.followups.index') }}"
                    class="sidebar-link flex items-center space-x-3 px-3 py-2.5 rounded-xl text-gray-300 hover:text-white {{ request()->routeIs('admin.followups.*') ? 'active' : '' }}">
                    <svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                <a href="{{ route('admin.questionnaire.fields.index') }}"
                    class="sidebar-link flex items-center space-x-3 px-3 py-2.5 rounded-xl text-gray-300 hover:text-white {{ request()->routeIs('admin.questionnaire.*') ? 'active' : '' }}">
                    <svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            d="M8.228 9c.549-1.165 2.03-2 3.772-2 2.21 0 4 1.343 4 3 0 1.4-1.278 2.575-3.006 2.907-.542.104-.994.54-.994 1.093m0 3h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
                    </svg>
                    <span x-show="sidebarOpen">Questionnaire</span>
                </a>
